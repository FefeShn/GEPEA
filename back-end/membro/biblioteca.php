  ...
  <div class="container-scroller">
    ...
    <button id="botao-menu" aria-label="Abrir menu">☰</button>
      <nav class="menu-lateral" id="menuLateral">
        <ul>
          <li><a href="index-membro.php" ><i class="ti-agenda mr-2"></i>Publicações</a></li>
          <li><a href="acoes-membro.php"><i class="ti-agenda mr-2"></i>Ações</a></li>
          <li><a href="sobre-membro.php"><i class="ti-agenda mr-2"></i>Sobre o GEPEA</a></li>
          <li><a href="membros-membro.php"><i class="ti-agenda mr-2"></i>Membros</a></li>
          <li><a href="biblioteca.php" class="active"><i class="ti-agenda mr-2"></i>Biblioteca</a></li>
