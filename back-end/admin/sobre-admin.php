    ...
    <!-- FIM DA NAV BAR -->
      ...
      <nav class="menu-lateral" id="menuLateral">
        <ul>
          ...
          <li><a href="sobre-admin.php" class="active"><i class="ti-book mr-2"></i>Sobre o GEPEA</a></li>
          ...
          <li><a href="suporte-admin.php"><i class="ti-user mr-2"></i>Suporte</a></li>
        </ul>
      </nav>
          ...
          <div class="sobre-container">
            <div class="sobre-content">
              ...
              <div class="sobre-texto">
                ...
                <h4>Principais Áreas de Atuação</h4>
                <ul>
                  <li>blablabla</li>
                  <li>pipipi</li>
                  <li>popopo</li>
