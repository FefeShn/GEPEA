...
<head>
  ...
  <!-- Ícones (usando Tabler Icons via CDN) -->
...
<body>
  <div class="container-scroller">
    ...
    <nav class="menu-lateral" id="menuLateral">
      <ul>
        <li><a href="index-admin.php"><i class="ti-agenda mr-2"></i>Publicações</a></li>
        <li><a href="acoes-admin.php"><i class="ti-agenda mr-2"></i>Ações</a></li>
        <li><a href="sobre-admin.php"><i class="ti-agenda mr-2"></i>Sobre o GEPEA</a></li>
        <li><a href="membros-admin.php"><i class="ti-agenda mr-2"></i>Membros</a></li>
        <li><a href="biblioteca-admin.php" class="active"><i class="ti-agenda mr-2"></i>Biblioteca</a></li>
        ...
        <li><a href="../anonimo/suporte.php"><i class="ti-agenda mr-2"></i>Suporte</a></li>
      </ul>
    </nav>
