            ...
            <div class="row">
              <div class="col-12 col-xl-8 mb-4 mb-xl-0">
                <div class="titulo-publicacoes"> 
                  <h3 class="font-weight-bold">zsdfc gvhbkjl</h3>
          ...
          <div id="carouselExampleIndicators" class="carousel slide" data-bs-ride="carousel">
            ...
            <div class="carousel-inner">
              <div class="carousel-item active">
                <img src="../imagens/publicacoes/pub_20251024_225433_56f1211e.jpg" class="d-block w-100" alt="Imagem da publicação">
                <div class="carousel-caption d-none d-md-block">
                  <p>zsdfc gvhbkjl</p>
                </div>
              </div>
              <div class="carousel-item ">
                <img src="../imagens/publicacoes/pub_20251024_225453_bfd54cdf.jpg" class="d-block w-100" alt="Imagem da publicação">
                <div class="carousel-caption d-none d-md-block">
                  <p>zsdfc gvhbkjl</p>
                </div>
              </div>
