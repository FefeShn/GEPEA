            ...
            <div class="row">
              <div class="col-12 col-xl-8 mb-4 mb-xl-0">
                <div class="titulo-publicacoes"> 
                  <h3 class="font-weight-bold">Reunião de Leitura</h3>
                  <h6 class="font-weight-normal mb-0">Publicado em 13/03/2025</h6>
                </div>
              </div>
            </div>
          </div>
          ...
          <div id="carouselExampleIndicators" class="carousel slide" data-bs-ride="carousel">
            ...
            <div class="carousel-inner">
              <div class="carousel-item active">
                <img src="../imagens/reuniaogepea.jpeg" class="d-block w-100" alt="Membros do GEPEA em reunião via Google Meet">
                <div class="carousel-caption d-none d-md-block">
                  <p>Reunião de Leitura via Google Meet</p>
                </div>
              </div>
            </div>
          </div>
