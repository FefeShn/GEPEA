            ...
            <div class="row">
              <div class="col-12 col-xl-8 mb-4 mb-xl-0">
                <div class="titulo-publicacoes"> 
                  <h3 class="font-weight-bold">Reunião presencial em Alvorada</h3>
                  <h6 class="font-weight-normal mb-0">Publicado em 25/03/2025</h6>
                </div>
              </div>
            </div>
          </div>
          ...
          <div id="carouselExampleIndicators" class="carousel slide" data-bs-ride="carousel">
            ...
            <div class="carousel-inner">
              <div class="carousel-item active">
                <img src="../imagens/gepeaalvorada.jpeg" class="d-block w-100" alt="Membros do GEPEA reunidos no IFRS - Campus Alvorada">
