...
<body>
  <div class="container-scroller">
    ...
    <nav class="menu-lateral" id="menuLateral">
      <ul>
        <li><a href="../anonimo/index.php" ><i class="ti-home mr-2"></i>Publicações</a></li>
        <li><a href="../anonimo/acoes.php" class="active"><i class="ti-home mr-2"></i>Ações</a></li>
        <li><a href="../anonimo/sobre.php"><i class="ti-book mr-2"></i>Sobre o GEPEA</a></li>
        <li><a href="../anonimo/membros.php"><i class="ti-agenda mr-2"></i>Membros</a></li>
            ...
            <div class="row">
              <div class="col-12 col-xl-8 mb-4 mb-xl-0">
                <div class="titulo-publicacoes"> 
                  <h3 class="font-weight-bold">GEPEA presente no Salão de Bento Gonçalves</h3>
                  <h6 class="font-weight-normal mb-0">Publicado em 05/12/2024</h6>
                </div>
              </div>
            </div>
          </div>
          ...
          <div class="sobre-content">
            <div id="carouselExample" class="carousel">
              <div class="carousel-inner">
                <div class="carousel-item active">
                  <img src="../imagens/bento.jpeg" class="d-block w-100" alt="Artigo Publicado">
                </div>
                <div class="carousel-item active">
                  <img src="../imagens/dani-gaby-salao.png" class="d-block w-100" alt="Artigo Publicado">
                </div>
                <div class="carousel-item active">
                  <img src="../imagens/salao-meninas.jpeg" class="d-block w-100" alt="Artigo Publicado">
                </div>
              </div>
            ...
            <div class="sobre-texto">
              <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nam posuere neque dolor, ultricies eleifend nisl ultricies ac. In hac habitasse platea dictumst. Nam lobortis orci egestas enim molestie auctor. Sed vitae justo et arcu lacinia accumsan aliquet nec mauris. Aenean ante ex, pellentesque nec metus bibendum, pulvinar ultricies massa. Donec dictum ac massa vitae laoreet. Suspendisse placerat dui turpis, eu fermentum augue sodales eu. Sed convallis nisl velit, non auctor lorem ultrices vel. Duis luctus dui nunc. Vestibulum mi orci, gravida ac ante at, ullamcorper faucibus enim. Phasellus sit amet mollis massa. Quisque augue lorem, ornare in dapibus quis, iaculis id dui. Donec vel mattis sapien, ac gravida diam. Vestibulum ante ipsum primis in faucibus orci luctus et ultrices posuere cubilia curae; Cras lacus metus, condimentum id tellus non, sagittis vehicula mi. Sed tristique sem non tincidunt laoreet.</p>
                <div class="carousel-inner">
                <div class="carousel-item active">
                  <img src="../imagens/fernanda-salao.png" class="d-block w-100" alt="Artigo Publicado">
                </div>
              </div>
              <div class="legenda">
              <p>legenda</p>
              ...
              <div class="carousel-inner">
                <div class="carousel-item active">
                  <img src="../imagens/giulia-salao.png" class="d-block w-100" alt="Artigo Publicado">
                </div>
              </div>
              <div class="legenda">
              <p>legenda</p>
              ...
              <div class="carousel-inner">
                <div class="carousel-item active">
                  <img src="../imagens/dani-salao.png" class="d-block w-100" alt="Artigo Publicado">
                </div>
              </div>
              <div class="legenda">
              <p>legenda</p>
