          ...
          <div class="col-md-12 grid-margin">
            <div class="row">
             ...
             <div class="sobre-content">
              ...
              <div id="carouselExampleIndicators" class="carousel slide" data-bs-ride="carousel">
                ...
                <div class="carousel-inner">
                  <div class="carousel-item active">
                    <img src="../imagens/bento.jpeg" class="d-block w-100" alt="Membros do GEPEA no Salão de Bento Gonçalves">
                    <div class="carousel-caption d-none d-md-block">
                      <p>Membros do GEPEA no Salão de Bento Gonçalves</p>
                    </div>
                  </div>
      
              <div class="carousel-item">
                <img src="../imagens/fernanda-salao.png" class="d-block w-100" alt="Membros do GEPEA no Salão de Bento Gonçalves">
                <div class="carousel-caption d-none d-md-block">
                  <p>Membros do GEPEA no Salão de Bento Gonçalves</p>
                </div>
              </div>
              ...
              <div class="carousel-item">
                <img src="../imagens/giulia-salao.png" class="d-block w-100" alt="Membros do GEPEA no Salão de Bento Gonçalves">
                <div class="carousel-caption d-none d-md-block">
                  <p>Membros do GEPEA no Salão de Bento Gonçalves</p>
                </div>
              </div>
