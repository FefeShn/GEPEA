    ...
    <!-- FIM DA NAV BAR -->
      ...
      <div class="biography-content">
        <div class="biography-photo">
          <img src="../imagens/flori.jpg" alt="Foto do Professor Luciano Corsino" class="profile-image">
        </div>
        
        <div class="biography-info">
          <h2 class="member-name">Me. Leandro Nogueira</h2>
          <p class="member-role membro">Membro</p>
          
          <div class="member-contacts">
            <a href="http://lattes.cnpq.br/6353740176364414" target="_blank" class="lattes-link">
              <img src="../imagens/lattes-icon.png" alt="Currículo Lattes" class="contact-icon">
              Currículo Lattes
            </a>
            <a href="mailto:leandro.mendes@gmail.com" class="email-link">
