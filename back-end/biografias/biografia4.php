    ...
    <!-- FIM DA NAV BAR -->
      ...
      <div class="biography-content">
        <div class="biography-photo">
          <img src="../imagens/roque.jpg" alt="Foto do Professor Luciano Corsino" class="profile-image">
        </div>
        
        <div class="biography-info">
          <h2 class="member-name">Danieri Ribeiro</h2>
          <p class="member-role membro">Membro</p>
          
          <div class="member-contacts">
            <a href="http://lattes.cnpq.br/5391934948115080" target="_blank" class="lattes-link">
              <img src="../imagens/lattes-icon.png" alt="Currículo Lattes" class="contact-icon">
              Currículo Lattes
            </a>
            <a href="mailto:danieri.ribeiro@gmail.com" class="email-link">
              <img src="../imagens/email-icon.png" alt="Email" class="contact-icon">
              danieri.ribeiro@gmail.com
            </a>
          </div>
