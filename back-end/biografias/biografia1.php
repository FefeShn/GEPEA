  ...
  <div class="container-scroller">
    ...
    <!-- FIM DA NAV BAR -->
      ...
      <nav class="menu-lateral" id="menuLateral">
        ...
        <li><a href="../anonimo/acoes.php"><i class="ti-home mr-2"></i>Ações</a></li>
      ...
      <div class="biography-content">
        <div class="biography-photo">
          <img src="../imagens/dino.jpg" alt="Foto do Professor Luciano Corsino" class="profile-image">
        </div>
        
        <div class="biography-info">
          <h2 class="member-name">Dr. Luciano Corsino</h2>
          <p class="member-role coordenador">Coordenador do GEPEA</p>
          
          <div class="member-contacts">
            <a href="http://lattes.cnpq.br/6302527743928486" target="_blank" class="lattes-link">
              <img src="../imagens/lattes-icon.png" alt="Currículo Lattes" class="contact-icon">
              Currículo Lattes
            </a>
            <a href="mailto:luciano.corsino@ifrs.rolante.edu.br" class="email-link">
              <img src="../imagens/email-icon.png" alt="Email" class="contact-icon">
              luciano.corsino@ifrs.rolante.edu.br
            </a>
          </div>
