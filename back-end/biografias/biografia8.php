    ...
    <!-- FIM DA NAV BAR -->
      ...
      <div class="biography-content">
        <div class="biography-photo">
          <img src="../imagens/dormino.jpg" alt="Foto do Professor Luciano Corsino" class="profile-image">
        </div>
        
        <div class="biography-info">
          <h2 class="member-name">Ma. Myllena Camargo</h2>
          <p class="member-role membro">Membro</p>
          
          <div class="member-contacts">
            <a href="http://lattes.cnpq.br/5951306735617460" target="_blank" class="lattes-link">
              <img src="../imagens/lattes-icon.png" alt="Currículo Lattes" class="contact-icon">
              Currículo Lattes
            </a>
            <a href="mailto:myllena.camargo@gmail.com" class="email-link">
              <img src="../imagens/email-icon.png" alt="Email" class="contact-icon">
              myllena.camargo@gmail.com
            </a>
          </div>
