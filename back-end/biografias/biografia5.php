    ...
    <!-- FIM DA NAV BAR -->
      ...
      <div class="biography-content">
        <div class="biography-photo">
          <img src="../imagens/musga.jpg" alt="Foto do Professor Luciano Corsino" class="profile-image">
        </div>
        
        <div class="biography-info">
          <h2 class="member-name">Brenda Marins</h2>
          <p class="member-role bolsista">Bolsista</p>
          
          <div class="member-contacts">
            <a href="http://lattes.cnpq.br/1667650051949078" target="_blank" class="lattes-link">
              <img src="../imagens/lattes-icon.png" alt="Currículo Lattes" class="contact-icon">
              Currículo Lattes
            </a>
            <a href="mailto:brenda.marins@gmail.com" class="email-link">
              <img src="../imagens/email-icon.png" alt="Email" class="contact-icon">
              brenda.marins@gmail.com
            </a>
          </div>
