...
$linkPerfil  = isset($_SESSION['id_usuario']) ? (($_SESSION['eh_adm'] ?? false) ? '../admin/index-admin.php' : '../membro/index-membro.php') : 'login.php';
...
function caminhoFotoPerfil(?string $foto): string {
  ...
  if (strpos($foto, '../') === 0) return $foto; // já relativo à pasta back-end
  if (strpos($foto, './') === 0) return '../' . substr($foto, 2);
  ...
  <main class="biography-container">
    ...
    <?php else: ?>
      <?php
        ...
        $bio    = $bioRaw !== '' ? nl2br(h($bioRaw)) : 'Sem biografia.';
      ...
      <div class="biography-inner">
        ...
        <div class="biography-content <?= $roleClass ?>">
          <div class="biography-photo">
            <img src="<?= h($foto) ?>" alt="Foto de <?= $nome ?>" class="profile-image">
          </div>
          <div class="biography-info">
            ...
            <div class="member-contacts">
              <?php if ($lattes !== ''): ?>
                <a href="<?= h($lattes) ?>" target="_blank" class="lattes-link">
